...
pub const POLY_PERIMETER_GRID_THICKNESS: f32 = 0.01;
pub const POLY_INTERIOR_GRID_THICKNESS: f32 = 0.005;

pub const FRACTIONAL_DELTA_SCALE: u32 = 10;

pub const CAMERA_LERP_SPEED: f32 = 5.0;

pub const CAMERA_UPPER_NORMALISE_TRIGGER: f32 = 1.3;
pub const CAMERA_LOWER_NORMALISE_TRIGGER: f32 = 0.9;
